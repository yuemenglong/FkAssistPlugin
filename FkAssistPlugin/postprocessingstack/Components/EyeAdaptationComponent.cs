namespace UnityEngine.PostProcessingV1
{
    public sealed class EyeAdaptationComponent : PostProcessingComponentRenderTexture<EyeAdaptationModel>
    {
        ...
        public Texture Prepare(RenderTexture source, Material uberMaterial)
        {
            ...
            {
                AssetBundle AB = AssetBundle.LoadFromFile(Application.dataPath + "/../plugins/PHIBL/postprocessingstack");
                m_EyeCompute = AB.LoadAsset<ComputeShader>("Assets/PostProcessing/Resources/Shaders/EyeHistogram.compute");
                AB.Unload(false);
            }
