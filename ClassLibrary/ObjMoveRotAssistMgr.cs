...
namespace ClassLibrary
{
  internal class ObjMoveRotAssistMgr : MonoBehaviour
  {
    ...
    private static ObjMoveRotAssistMgr.KEY[] ROTATION_MODE_KEYS = new ObjMoveRotAssistMgr.KEY[6]{ ObjMoveRotAssistMgr.KEY.OBJ_ROT_X, ObjMoveRotAssistMgr.KEY.OBJ_ROT_Y, ObjMoveRotAssistMgr.KEY.OBJ_ROT_Z, ObjMoveRotAssistMgr.KEY.OBJ_ROT_X_2, ObjMoveRotAssistMgr.KEY.OBJ_ROT_Y_2, ObjMoveRotAssistMgr.KEY.OBJ_ROT_Z_2 };
...
//    private Dictionary<ObjMoveRotAssistMgr.KEY, KeyUtil> keyUtils = new Dictionary<ObjMoveRotAssistMgr.KEY, KeyUtil>();
    private Dictionary<ObjMoveRotAssistMgr.KEY, string> DEFAULT_KEYS = new Dictionary<ObjMoveRotAssistMgr.KEY, string>() { { ObjMoveRotAssistMgr.KEY.OBJ_MOVE_XZ, "G" }, { ObjMoveRotAssistMgr.KEY.OBJ_MOVE_Y, "H" }, { ObjMoveRotAssistMgr.KEY.OBJ_ROT_X, "G" }, { ObjMoveRotAssistMgr.KEY.OBJ_ROT_Y, "H" }, { ObjMoveRotAssistMgr.KEY.OBJ_ROT_Z, "Y" }, { ObjMoveRotAssistMgr.KEY.OBJ_SCALE_X, "G" }, { ObjMoveRotAssistMgr.KEY.OBJ_SCALE_Y, "H" }, { ObjMoveRotAssistMgr.KEY.OBJ_SCALE_Z, "Y" }, { ObjMoveRotAssistMgr.KEY.OBJ_SCALE_ALL, "T" }, { ObjMoveRotAssistMgr.KEY.OBJ_ROT_X_2, "Shift+G" }, { ObjMoveRotAssistMgr.KEY.OBJ_ROT_Y_2, "Shift+H" }, { ObjMoveRotAssistMgr.KEY.OBJ_ROT_Z_2, "Shift+Y" } };
...
//    }
    ...
    private void Update()
    {
      ...
      if (this.mode == ObjMoveRotAssistMgr.KEY.NONE && (instance.selectObjects == null || instance.selectObjects.Length == 0))
        return;
    ...
    private void Move(Vector3 delta)
    {
      ...
      {
        Vector3 position = new Vector3((float) Screen.width * 0.5f, (float) Screen.height * 0.5f, Input.mousePosition.z);
    ...
    {
      Singleton<UndoRedoManager>.Instance.Push((ICommand) new GuideCommand.MoveEqualsCommand(this.targets.Select<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>((System.Func<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>) (v => new GuideCommand.EqualsInfo()
      {
        dicKey = v.Key,
    ...
    {
      GuideObjectManager instance = Singleton<GuideObjectManager>.Instance;
      Singleton<UndoRedoManager>.Instance.Push((ICommand) new GuideCommand.RotationEqualsCommand(this.targets.Select<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>((System.Func<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>) (v => new GuideCommand.EqualsInfo()
      {
        dicKey = v.Key,
    ...
    {
      GuideObjectManager instance = Singleton<GuideObjectManager>.Instance;
      Singleton<UndoRedoManager>.Instance.Push((ICommand) new ObjMoveRotAssistMgr.MoveRotEqualsCommand(this.targets.Select<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>((System.Func<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>) (v => new GuideCommand.EqualsInfo()
      {
        dicKey = v.Key,
        oldValue = this.oldPos[v.Key],
        newValue = v.Value.changeAmount.pos
      })).ToArray<GuideCommand.EqualsInfo>(), this.targets.Select<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>((System.Func<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>) (v => new GuideCommand.EqualsInfo()
      {
        dicKey = v.Key,
        oldValue = this.oldRot[v.Key],
        newValue = v.Value.changeAmount.rot
    ...
    {
      Vector3 vector3_1 = scaleDelta * Studio.Studio.optionSystem.manipuleteSpeed * ObjMoveRotAssistMgr.SCALE_RATIO;
      foreach (GuideObject guideObject in this.targets.Values)
      {
        if (guideObject.enableRot)
        {
    ...
    {
      GuideObjectManager instance = Singleton<GuideObjectManager>.Instance;
      Singleton<UndoRedoManager>.Instance.Push((ICommand) new GuideCommand.ScaleEqualsCommand(this.targets.Select<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>((System.Func<KeyValuePair<int, GuideObject>, GuideCommand.EqualsInfo>) (v => new GuideCommand.EqualsInfo()
      {
        dicKey = v.Key,
